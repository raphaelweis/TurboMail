...
const SELECT_USER_RELATIONS_QUERY = 'SELECT ' . USER_TABLE . '.' . ID_USER_TABLE . ', ' . USER_TABLE . '.' . FIRST_NAME_USER_TABLE . ', ' . USER_TABLE . '.' . LAST_NAME_USER_TABLE . ', ' . RELATION_TABLE . '.' . ID_RELATION_TABLE . ' AS id_relation '. ', ' . RELATION_TABLE . '.' . STATUS_RELATION_TABLE .
                                    ' FROM ' . USER_TABLE .
                                    ' JOIN ' . RELATION_TABLE .
