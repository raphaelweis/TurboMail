...
const INSERT_MESSAGE_QUERY = 'INSERT INTO ' . MESSAGE_TABLE . '(' . ID_RELATION_MESSAGE_TABLE . ', ' . ID_SENDER_MESSAGE_TABLE . ', ' . ID_RECEIVER_MESSAGE_TABLE . ', ' . MESSAGE_MESSAGE_TABLE . ', ' . DATE_MESSAGE_TABLE . ') VALUES (?, ?, ?, ?, ?);';
...
const SELECT_USER_RELATIONS_QUERY = 'SELECT ' . USER_TABLE . '.' . ID_USER_TABLE . ', ' . USER_TABLE . '.' . FIRST_NAME_USER_TABLE . ', ' . USER_TABLE . '.' . LAST_NAME_USER_TABLE . ', ' . RELATION_TABLE . '.' . ID_RELATION_TABLE . ' AS id_relation '. ', ' . RELATION_TABLE . '.' . ID_SENDER_RELATION_TABLE . ', ' . RELATION_TABLE . '.' . STATUS_RELATION_TABLE .
                                    ' FROM ' . USER_TABLE .
                                    ' JOIN ' . RELATION_TABLE .
                                    ' ON ((' . USER_TABLE . '.' . ID_USER_TABLE . ' = ' . RELATION_TABLE . '.' . ID_SENDER_RELATION_TABLE .
