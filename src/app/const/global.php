...
const SELECT_USER_RELATIONS_QUERY = 'SELECT ' . USER_TABLE . '.' . ID_USER_TABLE . ', ' . USER_TABLE . '.' . FIRST_NAME_USER_TABLE . ', ' . USER_TABLE . '.' . LAST_NAME_USER_TABLE . ' FROM ' . USER_TABLE . ' JOIN ' . RELATION_TABLE . ' ON ((' . USER_TABLE . '.' . ID_USER_TABLE . ' = ' . RELATION_TABLE . '.' . ID_SENDER_RELATION_TABLE . ' AND ' . RELATION_TABLE . '.' . ID_RECEIVER_RELATION_TABLE . '=?) OR (' . USER_TABLE . '.' . ID_USER_TABLE . ' = ' . RELATION_TABLE . '.' . ID_RECEIVER_RELATION_TABLE . ' AND ' . RELATION_TABLE . '.' . ID_SENDER_RELATION_TABLE . '=?)) WHERE ' . USER_TABLE . '.' . ID_USER_TABLE . '<>?;';
